...
export default class HomeScreen extends Component {
  ...
  getHeroesByQuery() {
    fetch(
      "https://gateway.marvel.com/v1/public/characters?nameStartsWith=" +
        this.state.query +
        "&apikey=02ee3d93e987a3a5be62d77604e7d8da" +
        "&limit=30",
      {
        headers: {
          Referer: "localhost"
  ...
  getAllHeroes() {
    ...
    fetch(
      "https://gateway.marvel.com/v1/public/characters?apikey=02ee3d93e987a3a5be62d77604e7d8da" +
        "&offset=" +
        this.state.offset,
      {
        headers: {
      ...
      .then(json =>
        this.setState({
          isLoading: false,
          listCharac: this.state.listCharac
            ? this.state.listCharac.concat(json.data.results)
            : json.data.results
        })
      );
  }
